...
function ConferencesTable({ conference }: { conference: Conference }) {
    return (
        <tr className="bg-[#FFF] hover:bg-[#F9F9F9] border-b">
            ...
            {/* organizer */}
            <td className="sm:pl-0 pl-4">
                <a href={conference["Contact"]} className="px-4 py-3 mr-0 mb-2 text-black text-md text-left hover:ring-1 hover:shadow-sm hover:ring-[#eee] focus:ring-2 focus:outline-none font-bold rounded-xl inline-flex items-center underline" target="_blank" rel="noopener noreferrer">
                    {/* organizer data */}
            ...
            <td className="sm:pl-0 pl-4">
                <a className="px-3.5 py-2.5 inline-flex items-center" rel="noopener noreferrer">
                    {/* location icon */}
                    <img src={location} className="h-6 w-6 mr-1" alt="contact icon" />
                    {/* location data */}
                    {conference["Location"]}
                </a>
            </td>
            ...
            <td className="sm:pl-8 pl-6">
                <a href={conference["Ticket"]} className="px-3.5 py-2.5 mr-0 mb-2 bg-[#eee] hover:ring-1 hover:shadow-sm hover:ring-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-200 rounded-xl inline-flex items-center" target="_blank" rel="noopener noreferrer">
                    {/* ticket icon */}
                    <img src={ticket} className="h-7 w-7" alt="ticket icon" />
                </a>
            </td>
        </tr>
    );
                    ...
                    <div className="flex flex-col items-center max-w-screen-xl sm:px-4 px-0 mx-auto mt-8 mb-4 sm:flex-row sm:justify-between">
                        ...
                        <form className="flex items-center animation glow delay-1">
                            <div className="relative sm:w-96 w-80">
                                ...
                                {/* search input */}
                                <input value={searchTerm} onChange={handleSearchInputChange} type="text" id="searchInput" className="block w-full p-4 pl-10 text-base text-black border border-gray-300 rounded-2xl focus:ring-black focus:border-black" placeholder="Search by conference" />
