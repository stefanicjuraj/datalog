    ...
    return (
        <tr className="bg-[#FFF] hover:bg-[#fff] border-b">
            ...
            <td className="sm:pl-2 pl-5">
                <a href={education["Contact"]} className="px-4 py-3 mr-0 mb-2 text-black text-md text-left bg-white hover:ring-1 hover:shadow-sm hover:ring-[#eee] focus:ring-2 focus:outline-none focus:ring-gray-200 font-bold rounded-xl inline-flex items-center underline" target="_blank" rel="noopener noreferrer">
                    {/* organizer icon */}
                    {education["Organizer"]}
                </a>
            </td>
                    ...
                    <div className="flex flex-col items-center max-w-screen-xl sm:px-4 px-0 mx-auto mt-8 mb-4 sm:flex-row sm:justify-between">
                        ...
                        <form className="flex items-center animation glow delay-1">
                            <div className="relative sm:w-96 w-80">
                                ...
                                {/* search input */}
                                <input value={searchTerm} onChange={handleSearchInputChange} type="email" id="searchInput" className="block w-full p-4 pl-10 text-base text-black border border-gray-300 rounded-2xl focus:ring-black focus:border-black" placeholder="Search by education" />
